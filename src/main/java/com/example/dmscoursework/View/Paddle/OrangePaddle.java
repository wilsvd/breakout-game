...
/**
 * The OrangePaddle class inherits from Paddle, so it has access to all the same
 ...
 * @since   04-01-2022
 */
public class OrangePaddle extends Paddle {

    private final double HALF = 0.5;
    /**
     * Constructs an orange paddle whose upper-left corner is specified by
     ...
     */
    public OrangePaddle(Point2D center, int width, int height, Rectangle container) {
    ...
    protected Rectangle makePaddle(int width, int height) {
        ...
        try {
            input = new FileInputStream(
                    "src/Assets/OrangeAssets/OrangePaddle.PNG");
