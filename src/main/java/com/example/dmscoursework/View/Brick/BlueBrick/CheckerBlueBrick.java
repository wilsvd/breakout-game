...
/**
 * The CheckerBlueBrick class inherits from Brick, so it has access
 ...
 * @since   04-01-2022
 */
public class CheckerBlueBrick extends Brick {
    ...
    private void setImagePattern() {
        ...
        try {
            input = new FileInputStream(
                    "src/Assets/BlueAssets/CheckerBlueBrick.PNG");
    ...
    /**
     * Constructs a checkered blue brick whose upper-left corner is specified by
     ...
     */
    public CheckerBlueBrick(Point2D point, Dimension2D size) {
