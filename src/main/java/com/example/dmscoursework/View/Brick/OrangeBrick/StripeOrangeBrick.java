...
/**
 * The StripeOrangeBrick class inherits from Brick, so it has access
 ...
 * @since   04-01-2022
 */
public class StripeOrangeBrick extends Brick {
    ...
    private void setImagePattern() {
        ...
        try {
            input = new FileInputStream(
                    "src/Assets/OrangeAssets/StripeOrangeBrick.PNG");
    ...
    /**
     * Constructs a striped orange brick whose upper-left corner is specified by
     ...
     */
    public StripeOrangeBrick(Point2D point, Dimension2D size) {
