...
/**
 * The StripeBlueBrick class inherits from Brick, so it has access
 ...
 * @since   04-01-2022
 */
public class StripeBlueBrick extends Brick {
    ...
    private void setImagePattern() {
        ...
        try {
            input = new FileInputStream(
                    "src/Assets/BlueAssets/StripeBlueBrick.PNG");
    ...
    /**
     * Constructs a striped blue brick whose upper-left corner is specified by
     ...
     */
    public StripeBlueBrick(Point2D point, Dimension2D size) {
