...
/**
 * The OrangeBrick class inherits from Brick, so it has access to all the same
...
public class OrangeBrick extends Brick {
    ...
    private void setImagePattern() {
        ...
        try {
            input = new FileInputStream(
                    "src/Assets/OrangeAssets/OrangeBrick.PNG");
    ...
    /**
     * Constructs a normal orange brick whose upper-left corner is specified by
     ...
     */
    public OrangeBrick(Point2D point, Dimension2D size) {
