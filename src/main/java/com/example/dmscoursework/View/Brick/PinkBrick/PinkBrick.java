...
/**
 * The PinkBrick class inherits from Brick, so it has access to all the same
...
public class PinkBrick extends Brick {
    ...
    private void setImagePattern() {
        ...
        try {
            input = new FileInputStream(
                    "src/Assets/PinkAssets/PinkBrick.PNG");
    ...
    /**
     * Constructs a normal pink brick whose upper-left corner is specified by
     ...
     */
    public PinkBrick(Point2D point, Dimension2D size) {
