...
/**
 * The PinkBall class inherits from Ball, so it has access to all the same
...
public class PinkBall extends Ball {
    ...
    /**
     * Constructor of the PinkBall which takes in a position as a Point2D
     * argument.
     *
     * @param center a Point2D, which is the position of the ball.
     */
    public PinkBall(Point2D center) {
    ...
    protected Circle makeBall(Point2D center, int radiusA, int radiusB) {
        ...
        try {
            input = new FileInputStream(
                    "src/Assets/PinkAssets/PinkBall.PNG");
