...
public class OrangeBrickTest {

    private OrangeBrick orangeBrick;
    ...
    public void setUp() {
        ...
        orangeBrick = new OrangeBrick(startPoint, dimension2D);
    }
    @Test
    public void getM_BrickShape() {
        Shape result = orangeBrick.GetM_BrickShape();
    ...
    public void setM_BrickShape() {
        ...
        orangeBrick.SetM_BrickShape(correct);
    ...
    public void isM_NotBroken() {
        boolean result = orangeBrick.IsM_NotBroken();
    ...
    public void findImpact() {
        ...
        int result = orangeBrick.FindImpact(ball);
    ...
    public void isImpacted() {
        ...
        Ball ball = new RubberBall(collisionPoint);
        boolean result = orangeBrick.IsImpacted(ball);
    ...
    public void setImpact() {
        orangeBrick.SetImpact(startPoint ,Brick.Crack.LEFT);
        boolean result = orangeBrick.IsM_NotBroken(); // Is false.
    ...
    @Test
    public void repair() {
        boolean initial = orangeBrick.IsM_NotBroken();
        orangeBrick.SetImpact(startPoint ,Brick.Crack.LEFT);
        orangeBrick.Repair();
        boolean after = orangeBrick.IsM_NotBroken();
