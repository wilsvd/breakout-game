...
public class CheckerBlueBrickTest {
    private CheckerBlueBrick checkerBlueBrick;
    ...
    public void setUp() {
        ...
        checkerBlueBrick = new CheckerBlueBrick(startPoint, dimension2D);
    }

    @Test
    public void getM_BrickShape() {
        Shape result = checkerBlueBrick.GetM_BrickShape();
    ...
    public void setM_BrickShape() {
        ...
        checkerBlueBrick.SetM_BrickShape(correct);
    ...
    public void isM_NotBroken() {
        boolean result = checkerBlueBrick.IsM_NotBroken();
    ...
    public void findImpact() {
        ...
        int result = checkerBlueBrick.FindImpact(ball);
    ...
    public void isImpacted() {
        ...
        Ball ball = new RubberBall(collisionPoint);
        boolean result = checkerBlueBrick.IsImpacted(ball);
    ...
    @Test
    public void repair() {
        boolean initial = checkerBlueBrick.IsM_NotBroken();
        checkerBlueBrick.SetImpact(startPoint ,Brick.Crack.LEFT);
        checkerBlueBrick.Repair();
        boolean after = checkerBlueBrick.IsM_NotBroken();
